 ...
 */
class WayTagEnumCreator {
	private static final String WAYTYPE_HIGHWAY = "HIGHWAY";
	private static final String WAYTYPE_RAILWAY = "RAILWAY";
	private static final String WAYTYPE_BUILDING = "BUILDING";
	private static final String WAYTYPE_LANDUSE = "LANDUSE";
	private static final String WAYTYPE_LEISURE = "LEISURE";
	private static final String WAYTYPE_AMENITY = "AMENITY";
	private static final String WAYTYPE_NATURAL = "NATURAL";
	private static final String WAYTYPE_WATERWAY = "WATERWAY";
	private static final String WAYTYPE_UNCLASSIFIED = "UNCLASSIFIED";
	...
	private static String wayType(String tag) {
		if (tag == null)
			return null;

		if (tag.startsWith("highway="))
			return WAYTYPE_HIGHWAY;
		else if (tag.startsWith("railway="))
			return WAYTYPE_RAILWAY;
		else if (tag.startsWith("building="))
			return WAYTYPE_BUILDING;
		else if (tag.startsWith("landuse="))
			return WAYTYPE_LANDUSE;
		else if (tag.startsWith("leisure="))
			return WAYTYPE_LEISURE;
		else if (tag.startsWith("amenity="))
			return WAYTYPE_AMENITY;
		else if (tag.startsWith("natural="))
			return WAYTYPE_NATURAL;
		else if (tag.startsWith("waterway="))
			return WAYTYPE_WATERWAY;
		else
			return WAYTYPE_UNCLASSIFIED;
	}
}